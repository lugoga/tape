...
tape = leaflet() |> 
    ...
    addPolygons(data = mangroves, group = 'Mangrove',
    ...
    addLayersControl(
        baseGroups = c("OpenStreetMap", "ESRI Imagery", "Ocean Basemap", "Topographic"),
        overlayGroups = c('Eneo Msingi', 'Eneo Kinga', 'Eneo Mpito', 'Hifadhi Hai','Shehia', 'Mangrove', 'MPA/MCA', 'Drawn Items', 'Graticule'),
        position = "topright",
        options = layersControlOptions(collapsed = FALSE)
    ) |>  
        hideGroup(group = c('Shehia', 'Hifadhi Hai', 'Mangrove', 'MPA/MCA', 'Drawn Items', 'Graticule'))|>
